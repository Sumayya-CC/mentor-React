    ...
    share= (
      ...
      <div className = 'split1 center1'>
        ...
        {/* <Button className={classes.button} onClick={deletePost}>Delete</Button>
          ...
          {/* {copySuccess} */}<div style={{marginLeft:'2%', paddingTop:'3%'}}>
...
<ShareIcon color="action" fontSize="large" style={{marginLeft:"23%",color:"white"}} onClick={() =>  navigator.clipboard.writeText('http://localhost:3002/Tarento/Mentor-Wish/'+props.params.shareId)}/>
        </div>
        {/* </div> */}
